...
--
-- Host: localhost:3306
-- Waktu pembuatan: 07 Des 2022 pada 02.38
-- Versi server: 8.0.30
-- Versi PHP: 8.1.10
...
CREATE TABLE `pasiens` (
  ...
  `alamat` varchar(100) DEFAULT NULL,
  `kartu_rs` varchar(50) DEFAULT NULL,
  `info_pasien` varchar(50) DEFAULT NULL,
...
INSERT INTO `pasiens` (`id_pasien`, `nik`, `nama`, `jenis_kelamin`, `gol_darah`, `tempat_lahir`, `tanggal_lahir`, `id_provinsi`, `id_kabupaten`, `alamat`, `kartu_rs`, `info_pasien`, `no_telp`, `email`, `created_at`, `updated_at`) VALUES
(10, '5103050101010006', 'Ari Sanjaya', 'Laki-laki', 'A', 'Badung', '2001-01-01', '17', '252', 'Nusa Dua', '1387597534', '1230463824', '08970282769', 'wayanarisanjaya01@gmail.com', '2022-12-06 12:59:45', '2022-12-06 12:59:45'),
(11, '5103050101010001', 'Ari Sanjaya', 'Laki-laki', 'A', 'Badung', '2001-01-01', '16', '249', 'Nusa Dua', '1314072346', '1551462324', '08970282769', 'wayanarisanjaya01@gmail.com', '2022-11-01 15:40:30', '2022-12-06 15:40:30'),
(12, '5103050101010002', 'Katon Jaya Deva Yogananada', 'Laki-laki', 'A', 'Badung', '2001-01-01', '', '', 'Nusa Dua', '1017684668', '1307454415', '', '', '2022-01-06 15:43:50', '2022-12-06 15:43:50'),
(13, '5103050101010001', 'Ari Sanjaya', 'Laki-laki', 'A', 'Badung', '2001-10-31', NULL, NULL, 'Nusa Dua', NULL, NULL, NULL, NULL, '2022-12-06 16:16:36', '2022-12-06 16:16:36'),
(14, '5103050101010002', 'Katon Jaya Deva Yogananada', 'Laki-laki', 'A', 'Badung', '2002-05-24', NULL, NULL, 'Nusa Dua', NULL, NULL, NULL, NULL, '2022-12-06 16:16:36', '2022-12-06 16:16:36'),
(15, '5103050101010003', 'Iwan Sandhitama', 'Laki-laki', 'A', 'Buleleng', '2002-08-20', NULL, NULL, 'Nusa Dua', NULL, NULL, NULL, NULL, '2022-12-06 16:16:36', '2022-12-06 16:16:36'),
(16, '5103050101010004', 'Dedo Karmanata', 'Laki-laki', 'A', 'Karangasem', '2002-09-04', NULL, NULL, 'Nusa Dua', NULL, NULL, NULL, NULL, '2022-12-06 16:16:36', '2022-12-06 16:16:36'),
(17, '5103050101010005', 'Walter Andrian', 'Laki-laki', 'A', 'Bekasi', '2002-08-09', NULL, NULL, 'Nusa Dua', NULL, NULL, NULL, NULL, '2022-12-06 16:16:36', '2022-12-06 16:16:36'),
(18, '5103050101010006', 'Meidi Dharma', 'Laki-laki', 'A', 'Denpasar', '2002-05-28', '16', '251', 'Nusa Dua', NULL, NULL, '', '', '2022-12-06 16:16:36', '2022-12-06 16:49:42'),
(19, '5103050101010007', 'Arditha Kartika Putra', 'Laki-laki', 'A', 'Badung', '2002-07-15', NULL, NULL, 'Nusa Dua', NULL, NULL, NULL, NULL, '2022-12-06 16:16:36', '2022-12-06 16:16:36');
...
--
-- Stand-in struktur untuk tampilan `show_umur`
-- (Lihat di bawah untuk tampilan aktual)
--
CREATE TABLE `show_umur` (
`labels` varchar(8)
,`jumlah` bigint
);
...
--
-- Struktur untuk view `show_umur`
--
DROP TABLE IF EXISTS `show_umur`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `show_umur`  AS SELECT (case when (`dummy_table`.`umur` < 20) then '0 - 20' when (`dummy_table`.`umur` between 20 and 40) then '20 - 40' when (`dummy_table`.`umur` between 41 and 60) then '41 - 60' when (`dummy_table`.`umur` >= 61) then '61 - 100' when (`dummy_table`.`umur` is null) then '(NULL)' end) AS `labels`, count(0) AS `jumlah` FROM (select timestampdiff(YEAR,`pasiens`.`tanggal_lahir`,curdate()) AS `umur` from `pasiens`) AS `dummy_table` GROUP BY `labels` ORDER BY `labels` ASC  ;
